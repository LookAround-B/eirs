...
const experiences = [
  {
    ...
    description:
      "Ride through ancient forests and open plains of the Rajasthan countryside. Dawn and dusk rides available, with experienced guides leading routes through private estate trails and surrounding wilderness.",
    image: expTrail,
    duration: "2–4 Hours",
    level: "All Levels",
    tag: "01",
  },
  {
    ...
    description:
      "Experience live polo at our regulation-size field. From introductory chukkers to competitive club matches, immerse yourself in the most exhilarating equestrian sport with world-class players and ponies.",
    image: expPolo,
    duration: "Half Day",
    level: "Intermediate+",
    tag: "02",
  },
  {
    ...
    description:
      "Personalized instruction from Olympic-level trainers. Whether you're a beginner finding your seat or an advanced rider perfecting your half-pass, every session is tailored to your exact progression.",
    image: expPrivate,
    duration: "60–90 Min",
    level: "All Levels",
    tag: "03",
