          ...
          >
            <div className="relative aspect-[16/9] md:aspect-[21/9] overflow-hidden">
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-12 lg:p-16">
                <span className="label-mono text-[10px] opacity-50 mb-3">{experience.tag}</span>
                <h2 className="heading-display text-foreground text-3xl md:text-4xl lg:text-5xl mb-1">
                  {experience.title}
                </h2>
                <p className="label-mono text-sm text-primary mb-4">{experience.subtitle}</p>
                <p className="prose-luxury text-sm max-w-lg mb-6 hidden md:block">{experience.description}</p>
